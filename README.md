...
Soy Técnico en Análisis y Desarrollo de Software y actualmente curso la Tecnología en ADSO en el SENA, en Medellín. 🇨🇴
...
- Lógica y Desarrollo: Algoritmos, Lógica de programación, SQL y bases de los lenguajes vistos en el SENA.
- Gestión y Productividad: Trello (Metodologías ágiles), Microsoft Excel, VS Code.
- Hardware: Aficionado al ensamble y optimización de sistemas para alto rendimiento.
...
### Dato curioso
Cuando no estoy frente a la pantalla, me gusta jugar Tenis de Mesa. Es mi forma favorita de entrenar la concentración y los reflejos rápidos.
---

como encontrarme:
https://www.linkedin.com/in/camilo-muñoz-0847963ba  | Caanmucelis@gmail.com
